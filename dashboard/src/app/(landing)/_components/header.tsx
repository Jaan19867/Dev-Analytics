...
export const Header = () => {
  return (
    <header className="px-2 py-4 lg:py-6 z-20">
      <div className="container flex items-center gap-2 p-0">
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className="focus:outline-none focus:ring-1 md:hidden" size="icon" variant="outline">
        ...
        <Link className="flex items-center justify-center text-xl font-medium text-white" href="/">
